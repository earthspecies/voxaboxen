...
def main():
  ...
  local['python']['../main.py',
                  ...
                  '--project-dir=/home/jupyter/sound_event_detection/projects/MT_experiment'] & FG
  ...
  for lr in [.0001, .00005, .00001]:
    for batch_size in [32, 4]:
      local['python']['../main.py',
                      'train-model',
                      '--project-config-fp=/home/jupyter/sound_event_detection/projects/MT_experiment/project_config.yaml',
                      f'--name=m{j}',
