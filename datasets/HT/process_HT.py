# script to process HT data from https://zenodo.org/record/5412896
...
def process_audio_and_annot(annot, audio, sr, train_proportion, val_proportion, labels = ['GRN', 'GIG', 'SQT', 'RUM', 'WHP']):
  low_hz = 100
  high_hz = sr/2 - low_hz
