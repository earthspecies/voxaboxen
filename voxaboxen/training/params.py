...
def parse_args(args,allow_unknown=False):
    ...
    parser.add_argument('--n-val-fit', type=int, default=19, help="number of thresholds to try when fitting comb_discard_thresh and comb_iou_thresh on the val set")
    parser.add_argument('--n-map', type=int, default=30, help="number of detection_thresholds to sweep when calculating mean average precision")
